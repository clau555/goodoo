	...
	def update(self, player):
		...
		if Globals.counter%40 == 0 and player.rect.top >= self.rect.top and player.rect.bottom <= self.rect.bottom:
			...
			if (player.rect.right <= self.rect.left):
				Projectile(self.rect.x + self.width/2, self.rect.y + self.width/2, self.rect.x, self.rect.y + self.width/2)
			# tir à droite
			elif (player.rect.left >= self.rect.right):
				Projectile(self.rect.x + self.width/2, self.rect.y + self.width/2, self.rect.x + self.width, self.rect.y + self.width/2)
		# tir polydirectionnel
		elif Globals.counter%180 == 0:
			Projectile(self.rect.x + self.width/2, self.rect.y + self.width/2, self.rect.x, self.rect.y)
			Projectile(self.rect.x + self.width/2, self.rect.y + self.width/2, self.rect.x + self.width/2, self.rect.y)
			Projectile(self.rect.x + self.width/2, self.rect.y + self.width/2, self.rect.x + self.width, self.rect.y)
			Projectile(self.rect.x + self.width/2, self.rect.y + self.width/2, self.rect.x + self.width, self.rect.y + self.width/2)
			Projectile(self.rect.x + self.width/2, self.rect.y + self.width/2, self.rect.x + self.width, self.rect.y + self.width)
			Projectile(self.rect.x + self.width/2, self.rect.y + self.width/2, self.rect.x + self.width /2, self.rect.y + self.width)
			Projectile(self.rect.x + self.width/2, self.rect.y + self.width/2, self.rect.x, self.rect.y + self.width)
			Projectile(self.rect.x + self.width/2, self.rect.y + self.width/2, self.rect.x, self.rect.y + self.width/2)
