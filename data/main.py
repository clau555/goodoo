...
from data.constants import SCREEN_SIZE, FPS, BLACK
from data.playerCode import display_player, update_velocity, move_and_collide, get_grid_index
...
def main() -> None:
    ...
    pygame.init()
    pygame.display.set_mode(SCREEN_SIZE, pygame.NOFRAME)
    ...
    while True:
        ...
        neighbor_tiles: List[TileData] = get_neighbor_tiles(tile_grid, get_grid_index(player))
