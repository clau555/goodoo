...
from data.utils.screen import SCREEN_SIZE, world_to_screen
...
TILE_SPRITE: Surface = pygame.transform.scale(TILE_IMG, world_to_screen(TILE_SPRITE_SIZE))
...
GROUND_SPRITE: Surface = pygame.transform.scale(GROUND_IMG, world_to_screen(GROUND_SPRITE_SIZE))

PILLAR_TOP_IMG: Surface = pygame.image.load("resources/sprites/pillar_top.png")
PILLAR_TOP_SPRITE_SIZE: Vector2 = Vector2(16)
PILLAR_TOP_SPRITE: Surface = pygame.transform.scale(PILLAR_TOP_IMG, world_to_screen(PILLAR_TOP_SPRITE_SIZE))

PILLAR_IMG: Surface = pygame.image.load("resources/sprites/pillar.png")
PILLAR_SPRITE_SIZE: Vector2 = Vector2(12)
PILLAR_SPRITE: Surface = pygame.transform.scale(PILLAR_IMG, world_to_screen(PILLAR_SPRITE_SIZE))
...
GOAL_SPRITES: List[Surface] = list(map(
    lambda img: pygame.transform.scale(img, world_to_screen(GOAL_SIZE)),
    GOAL_IMAGES
))

PLAYER_IMG: Surface = pygame.image.load("resources/sprites/player.png")
PLAYER_SIZE: Vector2 = Vector2(8)
PLAYER_SPRITE: Surface = pygame.transform.scale(PLAYER_IMG, world_to_screen(PLAYER_SIZE))
...
CURSOR_SPRITE: Surface = pygame.transform.scale(pygame.image.load("resources/sprites/cursor.png"), world_to_screen(PLAYER_SIZE))
